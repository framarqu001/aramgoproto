...
RIOT_API_KEY = 'RGAPI-f3ba6b20-ee30-4f99-9ddf-9dddd7981866'
REGION = 'na1'  # Example: 'na1' for North America
SUMMONER_NAME = 'UniqueKD'
...
def fetch_aram_match_history(puuid):
    url = f'https://americas.api.riotgames.com/lol/match/v5/matches/by-puuid/{puuid}/ids?queue=450&count=1&api_key={RIOT_API_KEY}'
    response = requests.get(url)
